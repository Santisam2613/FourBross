...
import { Users, ShoppingBag, TrendingUp, Search, ArrowRight } from 'lucide-react';
    ...
    <div className="space-y-6 pb-20 md:pb-0">
      <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
        <div>
          ...
          <p className="text-sm text-zinc-500 mt-1">Seguimiento de clientes y órdenes en un solo lugar.</p>
        </div>
        <div className="flex gap-2 w-full md:w-auto">
          <div className="relative w-full md:w-72">
            <Search className="absolute left-3 top-2.5 h-4 w-4 text-zinc-400" />
            <Input placeholder="Buscar cliente..." className="pl-9 h-10 rounded-2xl" />
          </div>
          <Link href="/commercial/clients">
            <Button className="rounded-full">Nuevo Cliente</Button>
          </Link>
        </div>
      </div>
        ...
        <Card className="rounded-2xl border-zinc-200">
          <CardContent className="p-6 flex items-center gap-4">
            ...
            <div>
              ...
              <h3 className="text-2xl font-semibold text-zinc-900">1,240</h3>
            </div>
          </CardContent>
        </Card>
        <Card className="rounded-2xl border-zinc-200">
          <CardContent className="p-6 flex items-center gap-4">
            <div className="h-12 w-12 bg-black/5 rounded-2xl flex items-center justify-center text-zinc-900">
        ...
        <Card className="rounded-2xl border-zinc-200">
          <CardContent className="p-6 flex items-center gap-4">
            ...
            <div>
              ...
              <h3 className="text-2xl font-semibold text-zinc-900">85%</h3>
            </div>
          </CardContent>
        </Card>
      </div>
      ...
      <Card className="rounded-2xl border-zinc-200">
        <CardHeader className="flex flex-row items-center justify-between">
          ...
          <Link href="/commercial/clients" className="text-sm font-semibold text-primary flex items-center gap-1">
                ...
                {recentClients.map((client) => (
                  <tr key={client.id} className="bg-white border-b hover:bg-zinc-50">
                    ...
                    <td className="px-6 py-4">
                      <div className="w-full bg-zinc-200 rounded-full h-2.5 max-w-[140px]">
